...
const ShowMap = () => {
	...
	useEffect(() => {
    	if (mapboxAccessToken) {
            ...
            const popup1 = new mapboxgl.Popup({offset: 25}).setText("Zona de Alto Riesgo SMCC001 \n Centro Comercial muy concurrido con probabilidad de pocos suministros");
            const popup2 = new mapboxgl.Popup({offset: 25}).setText("Zona de Alto Riesgo JMCC001 \n Centro Comercial muy concurrido con probabilidad de pocos suministros");
            const popup3 = new mapboxgl.Popup({offset: 25}).setText("Zona de Alto Riesgo JMCH002 \n Centro médico con gran cantidad de personas infectadas");
            const popup4 = new mapboxgl.Popup({offset: 25}).setText("Zona de Alto Riesgo PLCH001 \n Centro médico con gran cantidad de personas infectadas");
            const popup5 = new mapboxgl.Popup({offset: 25}).setText("Zona de Alto Riesgo MMCC001");
            const popup6 = new mapboxgl.Popup({offset: 25}).setText("Zona de Alto Riesgo SICE001");
            const popup7 = new mapboxgl.Popup({offset: 25}).setText("Zona de Alto Riesgo MMCM001");
            const popup8 = new mapboxgl.Popup({offset: 25}).setText("Zona de Alto Riesgo SICC001");
            const popup9 = new mapboxgl.Popup({offset: 25}).setText("Zona de Alto Riesgo CLCH001 Centro médico con gran cantidad de personas infectadas");
            const popup10 = new mapboxgl.Popup({offset: 25}).setText("Zona de Alto Riesgo CLCC001 Centro Comercial muy concurrido con probabilidad de pocos suministros")
            const popup11 = new mapboxgl.Popup({offset: 25}).setText("Zona de Alto Riesgo JMCE001 Centro educativo muy concurrido");
            const popup12 = new mapboxgl.Popup({offset: 25}).setText("Zona de Alto Riesgo SMCE001 Centro educativo muy concurrido");
            const popup13 = new mapboxgl.Popup({offset: 25}).setText("Zona de Alto Riesgo SMCE002 Centro educativo muy concurrido");
            const popup14 = new mapboxgl.Popup({offset: 25}).setText("Zona de Alto Riesgo CLCE001 Centro educativo muy concurrido");
            const popup15 = new mapboxgl.Popup({offset: 25}).setText("Zona de Alto Riesgo ")
            const popup19 = new mapboxgl.Popup({offset: 23}).setText("Zona de Alto Riesgo CLCH001 \n Centro de Salud muy concurrido")

            const popup30 = new mapboxgl.Popup({offset: 25}).setText("Zona de Bajo Riesgo")
            const popup31 = new mapboxgl.Popup({offset: 25}).setText("Zona de Bajo Riesgo")
            const popup32 = new mapboxgl.Popup({offset: 25}).setText("Zona de Bajo Riesgo")
            const popup33 = new mapboxgl.Popup({offset: 25}).setText("Zona de Bajo Riesgo")
            const popup34 = new mapboxgl.Popup({offset: 25}).setText("Zona de Bajo Riesgo")

            const market1 = new mapboxgl.Marker({color: "red", scale: 0.6})
                .setLngLat([-77.082301, -12.076970])
                .setPopup(popup1)
                .addTo(map);
            const market2 = new mapboxgl.Marker({color: "red", scale: 0.6})
                .setLngLat([-77.052211, -12.089856])
                .setPopup(popup2)
                .addTo(map);
            const market3 = new mapboxgl.Marker({color: "red", scale: 0.6})
                .setLngLat([-77.059761, -12.070720])
                .setPopup(popup3)
                .addTo(map);
            const market4 = new mapboxgl.Marker({color: "red", scale: 0.6})
                .setLngLat([-77.072859, -12.090034])
                .setPopup(popup4)
                .addTo(map);
            const market5 = new mapboxgl.Marker({color: "red", scale: 0.6})
                .setLngLat([-77.040112, -12.079034])
                .setPopup(popup5)
                .addTo(map);
            const market6 = new mapboxgl.Marker({color: "red", scale: 0.6})
                .setLngLat([-77.049910, -12.087713])
                .setPopup(popup6)
                .addTo(map);
            const market7 = new mapboxgl.Marker({color: "red", scale: 0.6})
                .setLngLat([-77.065181, -12.097418])
                .setPopup(popup7)
                .addTo(map);
            const market8 = new mapboxgl.Marker({color: "red", scale: 0.6})
                .setLngLat([-77.025322, -12.094065])
                .setPopup(popup8)
                .addTo(map)
            const market9 = new mapboxgl.Marker({color: "red", scale: 0.6})
                .setLngLat([-77.022421, -12.059314])
                .setPopup(popup9)
                .addTo(map)
            const market10 = new mapboxgl.Marker({color: "red", scale: 0.6})
                .setLngLat([-77.013873, -12.064043])
                .setPopup(popup10)
                .addTo(map)
            const market11 = new mapboxgl.Marker({color: "red", scale: 0.6})
                .setLngLat([-77.048823, -12.083832])
                .setPopup(popup11)
                .addTo(map)
            const market12 = new mapboxgl.Marker({color: "red", scale: 0.6})
                .setLngLat([-77.093861, -12.076517])
                .setPopup(popup12)
                .addTo(map)
            const market13 = new mapboxgl.Marker({color: "red", scale: 0.6})
                .setLngLat([-77.079851, -12.068988])
                .setPopup(popup13)
                .addTo(map)
            const market14 = new mapboxgl.Marker({color: "red", scale: 0.6})
                .setLngLat([-77.083233, -12.057603])
                .setPopup(popup14)
                .addTo(map)
            const market15 = new mapboxgl.Marker({color: "red", scale: 0.6})
                .setLngLat([-77.061038, -12.072226])
                .addTo(map)
            const market16 = new mapboxgl.Marker({color: "red", scale: 0.6})
                .setLngLat([-77.053530, -12.087815])
                .addTo(map)
            const market17 = new mapboxgl.Marker({color: "red", scale: 0.6})
                .setLngLat([-77.036162, -12.096893])
                .addTo(map)
            const market18 = new mapboxgl.Marker({color: "red", scale: 0.6})
                .setLngLat([-77.042590, -12.086277])
                .addTo(map)
            const market19 = new mapboxgl.Marker({color: "red", scale: 0.6})
                .setLngLat([-77.043809, -12.049837])
                .setPopup(popup19)
                .addTo(map)
            ...
            map.on('load', () => {
                ...
                },
                {
                    coordinates: [
                    [
                        [-77.077788, -12.068456], [-77.077791, -12.066199],
                        [-77.078108, -12.064180], [-77.079142, -12.060102],
                        [-77.087272, -12.061537], [-77.088407, -12.058826],
                        [-77.087573, -12.051633], [-77.078545, -12.050098],
                        [-77.076644, -12.046480], [-77.081651, -12.046940],
                        [-77.083029, -12.036447], [-77.077887, -12.035497],
                        [-77.071305, -12.034409], [-77.065611, -12.035012],
                        [-77.056986, -12.036522], [-77.048232, -12.035989],
                        [-77.045378, -12.038921], [-77.039421, -12.039021],
                        [-77.029261, -12.043228], [-77.016008, -12.043596],
                        [-77.013014, -12.038936], [-77.009892, -12.030589],
                        [-77.008198, -12.033261], [-77.008996, -12.033823],
                        [-77.005701, -12.037930], [-77.003057, -12.046786],
                        [-77.006835, -12.049590], [-77.008428, -12.046726],
                        [-77.007199, -12.042497], [-77.010977, -12.043744],
                        [-77.012372, -12.053598], [-77.005869, -12.060586],
                        [-77.002916, -12.061557], [-77.003214, -12.062523],
                        [-77.007235, -12.060222], [-77.015593, -12.061293],
                        [-77.017405, -12.057438], [-77.035321, -12.059764],
                        [-77.028164, -12.078651], [-77.036342, -12.079809],
                        [-77.038150, -12.067611], [-77.037528, -12.064204],
                        [-77.045709, -12.065241], [-77.041627, -12.060322],
                        [-77.042365, -12.050871], [-77.053755, -12.049101],
                        [-77.057516, -12.055482], [-77.059818, -12.063473],
                        [-77.061244, -12.067500],
                        [-77.077788, -12.068456]
                    ]
                    ],
                ...
                },
                {
                    coordinates: [
                    [
                        [-77.054214, -12.066499], [-77.049723, -12.070146],
                        [-77.041613, -12.060288], [-77.042349, -12.050864],
                        [-77.053804, -12.049080], [-77.055353, -12.052572],
                        [-77.057523, -12.055446], [-77.061252, -12.067535],
                        [-77.054214, -12.066499]
                    ]
                    ],
                    properties: {
